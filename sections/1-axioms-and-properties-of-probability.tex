...
\begin{enumerate}[series=prob]
    ...
    \prob{shopofsamplespaces}{
        The shop of sample spaces is open from $10:00$ to $20:00$. A student enters and leaves the shop at $x$ and $y$ hours after the opening, respectively. Describe the sample space $\Omega$ using elementary outcomes as $(x,y)$ pairs. Use the geometric probability model, draw $\Omega$ and the following events:
        \begin{enumerate}
    ...
    \prob{shopofsamplespaces2}{Calculate the probabilities of each event in the previous problem.}
