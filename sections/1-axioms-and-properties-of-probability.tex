...
\begin{enumerate}
    \item A fair coin is tossed three times. Model the experiment and describe the sample space. Find the probability of getting exactly two heads.
    \item Two fair six-sided dice are rolled. Describe the probability space. Find the probability that their sum is 7.
\end{enumerate}