...
\begin{enumerate}[resume=prob]
    ...
    \prob{}{
        The box contains 15 balls, 9 of which are new and 6 are used. We take 3 random balls for the first game and return them to the box. Next day we take 3 random balls for the second game. Find the probability that all 3 balls are new.
    }
    \prob{}{
        A witness sees a taxi involved in a crime and reports that it was blue. There are two taxi companies in town:
        \begin{itemize}
            \item 85\% of taxis belong to Company $A$ (which has blue taxis 80\% of the time).
            \item 15\% belong to Company $B$ (which has blue taxis 60\% of the time).
        \end{itemize}
        Given that a blue taxi was seen, what is the probability that it belonged to Company $A$?
    }
    \prob{}{
    ...
    \prob{}{
        A casino game has a 30\% chance of winning. If a player plays 50 times, what is the probability that they win between 10 and 20 times?
    }
\end{enumerate}