...
\begin{sol}{geom1}
    ...
    \end{tabular}
    \end{center}
    To draw $A\cup B$, $A\cap B$, $A\setminus B$, and $\overline{A}\cap\overline{B}$ we need to find the intersection point $(x_*,y_*)$ of the graphs of $y=1-x$ and $y=x^2$.
    For that purpose we set $x^2=1-x$, and solve for $x$ to get $x=\frac{-1\pm\sqrt5}{2}$. We need the one between $0$ and $1$, hence $x_*=\frac{\sqrt5-1}{2}$.
    Plugging in either one of the equations we get $y_*=\frac{3-\sqrt5}{2}$ Hence the intersection point is $(\frac{\sqrt5-1}{2},\frac{3-\sqrt5}{2})$.
    \[
